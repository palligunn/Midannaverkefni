...
function create() {//byggir leikinn með að setja inn allar myndir sem þú kallaðir á
	game.physics.startSystem(Phaser.Physics.ARCADE);//setur inn Arcade physics frá phaser
	...
	var ledge = platforms.create(400, 400, 'ground');//setur inn tvo aðra platforma og notar ground fyrir það
